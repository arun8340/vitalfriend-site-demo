...
const professionalPoints: { text: string; italic?: boolean }[] = [
  ...
  { text: "Vital Insights provides AI-assisted reporting to support clinician review." },
  { text: "Designed for straightforward onboarding and ongoing support." },
  { text: "We aggregate 1,000+ data points per patient per day, with AI-assisted modeling that organizes vitals into a comprehensive view for clinician review." },
  ...
  { text: "Vital Buddy is intended for use by healthcare professionals as an aid in patient monitoring. It is not intended to diagnose, treat, cure, or prevent any disease, and is not a substitute for clinical judgment.", italic: true },
];
    ...
    <>
        ...
        <section className={s.heroSection}>
          <div className={s.heroInner}>
            <h1 className={s.heroTitle}>
              The Remote Senior<br />Monitoring Platform
            </h1>
      ...
      <section className={s.dataFlowSection}>
        <div className={s.dataFlowInner}>
          ...
          <h2 className={s.dataFlowTitle}>Data flows from Vital Buddy to all who need it</h2>
          <p className={s.dataFlowSubtitle}>From bedside data to clinical insight, a complete connected ecosystem</p>
          ...
          <div className={s.flowDiagram}>
            ...
            <div className={s.flowRow1}>
              ...
              <div className={s.flowCol}>
                ...
                <div className={s.flowCard}>
                  <div className={s.cardIconBox}>
                    <img src="/images/platform/Data-flows-svg/vital%20buddy.svg" width={32} height={32} alt="" />
                  </div>
                  <div>
                    <h3 className={s.cardTitle}>Vital Buddy</h3>
                    <p className={s.cardBody}>Comfortable wearable device that continuously monitors vitals</p>
                  </div>
                </div>
              </div>
              ...
              <div className={s.flowCol}>
                ...
                <div className={s.flowCard}>
                  <div className={s.cardIconBox}>
                    <img src="/images/platform/Data-flows-svg/vital%20link.svg" width={32} height={32} alt="" />
                  </div>
                  <div>
                    <h3 className={s.cardTitle}>Vital Link</h3>
                    <p className={s.cardBody}>An app that provides secure, HIPAA-compliant data transmission</p>
                  </div>
                </div>
              </div>
              ...
              <div className={s.flowCol}>
                ...
                <div className={s.flowCard}>
                  <div className={s.cardIconBox}>
                    <img src="/images/platform/Data-flows-svg/integrations.svg" width={32} height={32} alt="" />
                  </div>
                  <div>
                    <h3 className={s.cardTitle}>Integrations</h3>
                    <p className={s.cardBody}>The VitalFriend platform integrates with 250 medical/wearable devices</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={s.connectorsSection}>
              ...
              >
                <defs>
                  <linearGradient id="intg" x1="0" y1="0" x2="1520" y2="0" gradientUnits="userSpaceOnUse">
                ...
                <rect x="1326" y="0" width="4" height="187" rx="2" fill="url(#intg)" />
                {/* Horizontal left to VI right edge at VI card middle */}
                <rect x="960" y="183" width="366" height="4" rx="2" fill="url(#intg)" />
            ...
            <div className={s.flowRow2}>
              <div className={s.flowInsightsCol}>
                ...
                <div className={s.flowCard}>
                  <div className={s.cardIconBox}>
                    <img src="/images/platform/Data-flows-svg/vaital%20insights.svg" width={32} height={32} alt="" />
                  </div>
                  <div>
                    <h3 className={s.cardTitle}>Vital Insights</h3>
                    <p className={s.cardBody}>AI-assisted analytics for physicians, caregivers and families</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              <defs>
                <linearGradient id="tcg" x1="0" y1="0" x2="1200" y2="0" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stopColor="#00D5BE" />
                  <stop offset="100%" stopColor="#00BBA7" />
                </linearGradient>
              </defs>
              {/* Stem */}
              <rect x="598" y="0" width="4" height="32" rx="2" fill="url(#tcg)" />
              {/* T-bar */}
              <rect x="192" y="30" width="816" height="4" rx="2" fill="url(#tcg)" />
              {/* Left drop */}
              <rect x="190" y="34" width="4" height="26" rx="2" fill="url(#tcg)" />
              {/* Center drop */}
              <rect x="598" y="34" width="4" height="26" rx="2" fill="url(#tcg)" />
              {/* Right drop */}
              <rect x="1006" y="34" width="4" height="26" rx="2" fill="url(#tcg)" />
              {/* Arrow tips */}
            ...
            <div className={s.flowRow3}>
              <div className={s.blueCard}>
                <div className={s.blueCardIcon}>
                  <img src="/images/platform/Data-flows-svg/physicians.svg" width={36} height={36} alt="" />
                </div>
                <h3 className={s.blueCardTitle}>Physicians</h3>
                <p className={s.blueCardSub}>Real-time clinical notifications</p>
              </div>

              <div className={s.blueCard}>
                <div className={s.blueCardIcon}>
                  <img src="/images/platform/Data-flows-svg/caregivers.svg" width={36} height={36} alt="" />
                </div>
                <h3 className={s.blueCardTitle}>Caregivers</h3>
                <p className={s.blueCardSub}>Helpful reminders &amp; notifications</p>
              </div>

              <div className={s.blueCard}>
                <div className={s.blueCardIcon}>
                  <img src="/images/platform/Data-flows-svg/family.svg" width={36} height={36} alt="" />
                </div>
      ...
      <section className={s.nextLevelSection}>
        <div className={s.nextLevelInner}>
          <div className={s.nextLevelText}>
            <h2 className={s.nextLevelTitle}>A Platform That Enables Next-Level Care</h2>
            <p className={s.nextLevelBody}>
              Our platform doesn&apos;t just collect data. It learns the user&apos;s unique baselines.
              Our AI-assisted tools help clinicians identify a trend or a deviation from an established
              baseline, and can send a customizable notifications to clinicians, caregivers and family.
            </p>
          </div>
          <Image
        ...
        <div className={s.howInner}>
          ...
          <div className={s.howHeader}>
            ...
            <p className={s.howSubtitle}>
              Data flows automatically from Vital Buddy through our platform where it is analyzed by our clinicians with AI-assisted tools.<br />
          ...
          <div className={s.howCards}>
            ...
            <div className={s.howCard}>
              <div className={s.howIconBox} style={{ background: "linear-gradient(135deg, #2B7FFF 0%, #00B8DB 100%)" }}>
                <img src="/images/platform/Vital-Buddy-Works/vital%20buddy%20captures.svg" width={32} height={32} alt="" />
              </div>
              <span className={s.howStep}>STEP 1</span>
              <h3 className={s.howCardTitle}>Vital Buddy captures</h3>
              <p className={s.howCardBody}>Key vitals and biomarkers, continuously on the wrist.</p>
            </div>
            ...
            {/* Step 2 */}
            <div className={s.howCard}>
              <div className={s.howIconBox} style={{ background: "linear-gradient(135deg, #00B8DB 0%, #00BBA7 100%)" }}>
                <img src="/images/platform/Vital-Buddy-Works/data%20uploads.svg" width={32} height={32} alt="" />
              </div>
              <span className={s.howStep}>STEP 2</span>
              <h3 className={s.howCardTitle}>Data uploads</h3>
              <p className={s.howCardBody}>Via VitalLink, our HIPAA-compliant data layer.</p>
            </div>
            ...
            {/* Step 3 */}
            <div className={s.howCard}>
              <div className={s.howIconBox} style={{ background: "linear-gradient(135deg, #AD46FF 0%, #F6339A 100%)" }}>
                <img src="/images/platform/Vital-Buddy-Works/clinicians%20interpret.svg" width={32} height={32} alt="" />
              </div>
              <span className={s.howStep}>STEP 3</span>
              <h3 className={s.howCardTitle}>Clinicians interpret</h3>
              <p className={s.howCardBody}>AI-assisted tools help clinicians identify issues.</p>
            </div>
            ...
            {/* Step 4 */}
            <div className={s.howCard}>
              <div className={s.howIconBox} style={{ background: "linear-gradient(135deg, #F6339A 0%, #FF2056 100%)" }}>
                <img src="/images/platform/Vital-Buddy-Works/caregivers%20notified.svg" width={32} height={32} alt="" />
              </div>
              <span className={s.howStep}>STEP 4</span>
              <h3 className={s.howCardTitle}>Caregivers notified</h3>
              <p className={s.howCardBody}>Notifications go to key players on the care team.</p>
            </div>
            ...
            {/* Step 5 */}
            <div className={s.howCard}>
              <div className={s.howIconBox} style={{ background: "linear-gradient(135deg, #F6339A 0%, #7920FF 100%)" }}>
                <img src="/images/platform/Vital-Buddy-Works/care%20provided.svg" width={32} height={32} alt="" />
              </div>
              <span className={s.howStep}>STEP 5</span>
              <h3 className={s.howCardTitle}>Care provided</h3>
              <p className={s.howCardBody}>Documented in EHR; CPT code billed.</p>
            </div>
          </div>

          {/* Outcomes banner */}
          <div className={s.howBanner}>
            <p className={s.howBannerLabel}>Median time, sensor → clinician acknowledgment:</p>
            <p className={s.howBannerHighlight}>Fewer surprises and better outcomes</p>
          </div>
        ...
        <div className={s.meetBuddyInner}>
          ...
          <div className={s.meetBuddyContent}>
            <h2 className={s.meetBuddyTitle}>
              Meet Vital Buddy<br />The FDA-Cleared Vitals<br />Wearable
            </h2>
            ...
            <p className={s.meetBuddyBody}>
              Vital Buddy, the first FDA-cleared medical watch, monitors blood pressure, heart rate,
        ...
        <div className={s.vitalInsightsInner}>
          ...
          <div className={s.vitalInsightsContent}>
            <h2 className={s.vitalInsightsTitle}>
              <span className={s.vitalInsightsGradient}>Vital Insights: </span>The Remote Senior Health Monitoring Platform
            </h2>
            ...
            <p className={s.vitalInsightsBody}>
              Our HIPAA-compliant platform captures 1,000+ data points per patient per day.
              AI-assisted modeling and licensed clinician review surface changes in monitored vitals
              and share them with the care team to support clinical decision-making.
            </p>
            <Link href="/scheduleDemo" className={s.vitalInsightsBtn}>Get a Demo</Link>
          </div>
        </div>
      </section>
        ...
        <div className={s.proInner}>
          ...
          <div className={s.proContentCol}>
            <h2 className={s.proTitle}>
              A Holistic View for<br />Healthcare Professionals
            </h2>
              ...
              {professionalPoints.map((point, i) => (
                <li key={i} className={s.proItem}>
                  <svg className={s.proCheckIcon} width="22" height="22" viewBox="0 0 22 22" fill="none">
                    <defs>
                      <linearGradient id={`cg${i}`} x1="0" y1="0" x2="1" y2="1" gradientUnits="objectBoundingBox">
                  ...
                  <span className={point.italic ? s.proItemItalic : undefined}>{point.text}</span>
                </li>
              ))}
            </ul>
          </div>
      ...
      <section className={s.vitalLinkSection}>
        <div className={s.vitalLinkInner}>
          ...
          <div className={s.vitalLinkContent}>
            ...
            <p className={s.vitalLinkSubtitle}>Smart Vitals Tracking. Important Metrics Monitored.</p>
            <div className={s.vitalLinkPoints}>
              <p className={s.vitalLinkIntro}>In addition to core connectivity, we provide:</p>
              {[
                ...
                <div key={i} className={s.vitalLinkItem}>
                  <svg className={s.proCheckIcon} width="22" height="22" viewBox="0 0 22 22" fill="none">
                    <defs>
                      <linearGradient id={`vlcg${i}`} x1="0" y1="0" x2="1" y2="1" gradientUnits="objectBoundingBox">
                        <stop offset="14.29%" stopColor="#6E70FF" />
                        <stop offset="85.29%" stopColor="#D393F1" />
                      </linearGradient>
                    </defs>
                    <circle cx="11" cy="11" r="10" stroke={`url(#vlcg${i})`} strokeWidth="1.5" />
                    <path d="M7 11.5l2.5 2.5 5.5-6" stroke={`url(#vlcg${i})`} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
      ...
      <section className={s.nextStepSection}>
        <div className={s.nextStepInner}>
          ...
          <h2 className={s.nextStepTitle}>
            Are you a MedTech, RPM or Device vendor<br />looking to partner with a first mover?
          </h2>

          {/* Description */}
          <p className={s.nextStepBody}>
            Schedule a meeting with a VitalFriend partner specialist. We&apos;ll walk you through the Vital Buddy<br />
          ...
          <div className={s.nextStepTrust}>
            ...
            <span className={s.nextStepTrustItem}>Insurance verification included</span>
