...
export const benefitCards: BenefitCards[] = [
  {
    icon: (
      ...
      >
        ...
        <circle cx="18" cy="18" r="15" stroke="#4D9AF1" strokeWidth="1.5" />
        <path
          d="M18 12V18L21 21"
          stroke="#4D9AF1"
          strokeWidth="1.5"
    ...
    icon: (
      ...
      >
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <path d="M18 27V33" stroke="#0089FF" strokeWidth="1.5" />
        <path
          d="M12 33H24"
          stroke="#0089FF"
          strokeWidth="1.5"
...
export const stayConnectedContent = [
  "Assess their current health and wellness",
  "Identify trends to ensure they're getting the right care",
  "Communicate with your loved one and their care team",
  "Get peace of mind knowing they're well cared for",
];
