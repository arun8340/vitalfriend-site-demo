    ...
    <>
        ...
        <div className={s.heroInner}>
          <div className={s.heroContent}>
            ...
            <p className={s.heroBody}>
              ...
              proactive, and personalized care, and that the people providing
              that care deserve tools that make their work easier, not harder.
            </p>
            <p className={s.heroBody}>
              Our platform revolutionizes the process of delivering care for
              people of all ages and situations, and especially seniors. Vital
            ...
            <Link href="/scheduleDemo" className={s.heroButton}>
              Learn More
            </Link>
          </div>
      ...
      <Section background="white" className="pt-0! pb-10!">
        <div className={s.sectionInner}>
          ...
          <p className={s.sectionBody}>
            We envision a world where technology, thoughtfully applied,
            transforms the health experience across every stage of life.
            Continuous insight helps people live longer, healthier, and more
            independently, giving care teams the clarity to act when it matters
            most and families the confidence that their loved ones are supported
      ...
      <Section background="white" className="pt-1.5! pb-13!">
        <div className={s.sectionInner}>
          ...
          <p className={s.sectionBody}>
            To bridge the gap between clinical precision and daily life by
            providing clinicians, facilities and families with continuous,
            medical-grade insights. We empower proactive care through reliable
            technology that supports patient independence and simplifies health
            management.
          </p>
        </div>
      </Section>
      ...
      <section className={s.statsSection}>
        <div className={s.statsInner}>
          <div className={s.statsHeadingBlock}>
            <h2 className={s.statsHeading}>
              Senior Care is at a Breaking Point
            </h2>
            <p className={s.statsSubtitle}>
              The need to provide more effective and efficient care solutions is
      ...
      <Section background="white" className="pt-12! lg:pt-14! pb-8! lg:pb-10!">
        <div className="text-center">
          ...
          <p className={s.teamDesc}>
            From our founders, to our executives, to our technical and domain
            specialists, meet the seasoned team that guides our growth and
            advances our solutions.
          </p>
        </div>
        <div className={s.teamGrid}>
          {executiveTeam.map((member) => (
            <div key={member.name} className={s.teamCard} style={member.hoverColor ? { "--card-hover-color": member.hoverColor } as React.CSSProperties : undefined}>
              {/* Default face: photo + name/role */}
              <div className={s.cardFront}>
                <div className={s.cardPhotoWrapper}>
                  {member.image ? (
                    <Image src={member.image} alt={member.name} width={376} height={404} className={s.cardPhoto} />
                  ) : (
                    <Image src="/images/about-us/default-person-image.png" alt={member.name} width={308} height={379} className={s.cardPhotoDefault} />
                  )}
                </div>
                <div className={s.cardNameRow}>
                  <p className={s.cardName}>{member.name}</p>
                  <p className={s.cardRole}>{member.role}</p>
                </div>
              </div>

              {/* Hover face: LinkedIn + bio + name/role */}
              <div className={s.cardBack}>
                <div className={s.cardBackTop}>
                  {member.linkedin && (
                    <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className={s.linkedinBtn} aria-label={`${member.name} on LinkedIn`}>
                  ...
                  {member.bio && <p className={s.cardBio}>{member.bio}</p>}
                </div>
                <div className={s.cardBackNameRow}>
                  <p className={s.cardName}>{member.name}</p>
                  <p className={s.cardRole}>{member.role}</p>
                </div>
              </div>
      ...
      <Section background="white" className="pt-1! lg:pt-1! pb-8! lg:pb-10!">
        <div className="text-center">
          ...
          <p className={s.advisorsDesc}>
            We&apos;re guided by an elite group of experts in business,
            engineering, product management, healthcare delivery, and more.
          </p>
        </div>
      ...
      <section className={s.talkSection}>
        <div className={s.talkCard}>
          <Image
            src="/images/about-us/talk-to-expert.png"
            alt="Talk to an expert"
            fill
            className={s.talkBgImage}
          />
          ...
          <div className={s.talkInner}>
            <p className={s.talkEyebrow}>
              ...
              >
                <path
                  d="M12 2C6.477 2 2 6.477 2 12c0 1.89.525 3.66 1.438 5.168L2 22l4.832-1.438A9.96 9.96 0 0 0 12 22c5.523 0 10-4.477 10-10S17.523 2 12 2z"
                  stroke="white"
                  strokeWidth="2"
                  strokeLinecap="round"
            ...
            <h2 className={s.talkHeading}>
              Ready to bring smarter care to your facility?
            </h2>
            <p className={s.talkSubtext}>
              Join 50+ care centers improving outcomes with VitalFriend.
            </p>
